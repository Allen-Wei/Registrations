...
insert into Colleges(Gid, Name, CanRegistrate) values(NEWID(), 'caijingdaxue', 1)
insert into Colleges(Gid, Name, CanRegistrate) values(NEWID(), 'zhongde', 0)
insert into Colleges(Gid, Name, CanRegistrate) values(NEWID(), 'dianzijishu', 0)
